...
| Arjun Chhabra | Frontend Developer - Core UI | Start screen with question count selector, Multiple choice questions UI, Shuffled answer order, Timer per question (10 seconds), Progress tracker (text + bar), End-of-quiz score display, Review mode (show your answers vs. correct), Replay functionality, Practice mode, Real-time leaderboard showcasing top-performing users, integration, and more |
